    ...
    for null in indexes:
        ...
        for alternative in indexes:
            ...
            result = {
                ...
                "image": create_exclusive_histogram(data=df, column=column, value=value, target=null,
...
def write_test_results(null, alpha, correction, results, mw_results, ind_results,
