...
class ObservationScrapper:
    def __init__(self, fetch_waterfalls=False, fetch_logging=True, prints=True):
        """
        ...
        self.json_file_loc = '../data/observations.json'
        self.dataframe_file_loc = "../data/observations.csv"
        self.log_file_loc = "../logs/logs.txt"
        self.waterfall_path = "../data/waterfalls/"
        self.prints = prints
